...
namespace ESFA.DC.ILR.Constants.Tests
{
    public class ILRContextKeysTests
    {
        ...
        [InlineData(ILRContextKeys.LearnerReferenceData, "LearnerReferenceData")]
        [InlineData(ILRContextKeys.FrmReferenceData, "FrmReferenceData")]
        ...
        [InlineData(ILRContextKeys.ReturnPeriodName, "ReturnPeriodName")]
